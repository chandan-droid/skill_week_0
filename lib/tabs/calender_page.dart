                    ...
                    children: [
                      ...
                      Text('Course',
                        style: const TextStyle(fontSize: 14,
                            ...
                            fontFamily: 'Poppins'),),
                      Expanded(child: SizedBox(),),
                      IconButton(onPressed: (){}, icon: ImageIcon(AssetImage('lib/assets/icons/filter.png'),color: Colors.grey,))
                    ],
                  ),
                ),
                SizedBox(
                  child: Column(
                    children: [
                      TimelineTile(
                        ...
                        endChild:ScheduleCard(subject: 'Mathematics',
                      ...
                      TimelineTile(
                        ...
                        endChild:ScheduleCard(subject: 'Biology',
                      ...
                      TimelineTile(
                        ...
                        endChild:ScheduleCard(subject: 'Geography',
                          chapter: 'Economy USA',
                          chapterNo: '2',
                          color1:Color(0xff4DC591),
                          color2: Color(0xff00664F),
